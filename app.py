...
# --- CONFIGURACIÓN TÉCNICA (ANDERSON & KRATHWOHL - GUÍA CGR) ---
	...
	# PROMPT FINAL (ADN INTEGRADO - ADAPTABLE A CUALQUIER ENTIDAD)
       ...
       METODOLOGÍA DE CONSTRUCCIÓN (NIVEL DE ESFUERZO):
        ...
        3. ⚖️ CAPITÁN ECUALIZADOR (SIMETRÍA DE CAMUFLAJE): Las IAs tienen el grave defecto de hacer la respuesta correcta más larga. ¡TIENES PROHIBIDO CAER EN ESTE SESGO! Regla inquebrantable: La respuesta correcta DEBE SER LA MÁS CORTA o tener EXACTAMENTE la misma extensión visual que los distractores. Guarda todas las explicaciones y justificaciones de la correcta ÚNICAMENTE para el campo "explicaciones" del JSON. En las opciones (A, B, C, D), limítate a dar la consecuencia jurídica directa, seca y sin rodeos. Rellena los distractores con jerga jurídica pesada para que se vean igual de imponentes. NADIE DEBE ADIVINAR POR EL TAMAÑO.
