...
# --- CONFIGURACIÓN TÉCNICA (ANDERSON & KRATHWOHL - GUÍA CGR) ---
	...
	# PROMPT FINAL (ADN INTEGRADO - ADAPTABLE A CUALQUIER ENTIDAD)
       ...
       METODOLOGÍA DE CONSTRUCCIÓN (NIVEL DE ESFUERZO):
        ...
        3. ⚖️ CAPITÁN ECUALIZADOR (SIMETRÍA VISUAL ESTRICTA): ¡Has logrado un excelente estilo directo y telegráfico en la respuesta correcta! MANTÉN ese tono seco, dando solo la consecuencia jurídica sin justificaciones. SIN EMBARGO, el usuario está adivinando porque la correcta siempre queda más corta. REGLA DE MUERTE: Las 4 opciones (A, B, C, D) DEBEN TENER EXACTAMENTE LA MISMA LONGITUD VISUAL. Si la respuesta correcta es directa y ocupa 1 o 2 líneas, los distractores (B, C, D) DEBEN ser igual de directos y ocupar exactamente la misma cantidad de líneas. Prohibido rellenar inútilmente las falsas si la verdadera es corta. Camuflaje perfecto por simetría de tamaño.
