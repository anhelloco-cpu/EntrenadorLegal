...
# --- CONFIGURACIÓN TÉCNICA (ANDERSON & KRATHWOHL - GUÍA CGR) ---
	...
	# PROMPT FINAL (ADN INTEGRADO - ADAPTABLE A CUALQUIER ENTIDAD)
       ...
       METODOLOGÍA DE CONSTRUCCIÓN (NIVEL DE ESFUERZO):
        ...
        3. ⚖️ CAPITÁN ECUALIZADOR (REGLA DE MUERTE): OBLIGATORIO. Las 4 opciones (A, B, C, D) DEBEN TENER EXACTAMENTE EL MISMO NÚMERO DE PALABRAS (margen de error de 3 palabras). Este es el error más grave que puedes cometer. PROHIBIDO hacer la respuesta correcta más detallada o explicativa. Si la correcta ocupa 2 líneas (ej. 25 palabras), las distractores B, C y D deben ser rellenadas con texto jurídico denso hasta alcanzar exactamente las mismas 25 palabras. NADIE DEBE ADIVINAR POR EL TAMAÑO.
